...
namespace Logic.Models
{
    sealed public class Round
    {
        ...
        private Round(ICollidableFactory collidableFactory)
        {
            ...
            Debug.WriteLine("!!!! Round constructor called");
        ...
        {
            Debug.WriteLine("[DEBUG] Purging round...");
            this.Snake.HeadCollidable.CollisionHandler -= onSnakeCollision;
            this._collisionSystem.PurgeCollidables();
